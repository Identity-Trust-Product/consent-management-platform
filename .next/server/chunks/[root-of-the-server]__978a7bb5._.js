module.exports = [
"[project]/.next-internal/server/app/cms/api/dashboard-config/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    callbacks: {
        async jwt ({ token, user, trigger }) {
            ...
            if (trigger === "update" || !token.roles) {
                if (token.id) {
                    const userWithRoles = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                        where: {
                            id: token.id
                        },
                        include: {
...
async function logAudit(params) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].auditLog.create({
            data: {
                action,
                resource,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Failed to write audit log", error, {
            params
        });
    }
}
...
"[project]/app/cms/api/dashboard-config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__978a7bb5._.js.map