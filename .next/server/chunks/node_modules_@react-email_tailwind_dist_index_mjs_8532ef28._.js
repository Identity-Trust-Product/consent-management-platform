module.exports = [
"[project]/node_modules/@react-email/tailwind/dist/index.mjs [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$code$2d$block$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@react-email/code-block/dist/index.mjs [instrumentation] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$code$2d$inline$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@react-email/code-inline/dist/index.mjs [instrumentation] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$link$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@react-email/link/dist/index.mjs [instrumentation] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwindcss$2f$dist$2f$lib$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/tailwindcss/dist/lib.mjs [instrumentation] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwindcss$2f$dist$2f$chunk$2d$MEY3PWYT$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__$3c$export__d__as__compile$3e$__ = __turbopack_context__.i("[project]/node_modules/tailwindcss/dist/chunk-MEY3PWYT.mjs [instrumentation] (ecmascript) <export d as compile>");
        ...
        loop: for(; cursor < this.tokenCount; cursor++){
            ...
            switch(stopConsume(this.source.charCodeAt(offset))){
                ...
                case 2:
                    ...
                    break loop;
                default:
                    if (isBlockOpenerToken(this.offsetAndType[cursor] >> TYPE_SHIFT)) cursor = balanceEnd;
            }
        }
...
var require_base64 = /* @__PURE__ */ __commonJS({
...
var require_base64_vlq = /* @__PURE__ */ __commonJS({
...
var require_util = /* @__PURE__ */ __commonJS({
...
var require_array_set = /* @__PURE__ */ __commonJS({
...
var require_mapping_list = /* @__PURE__ */ __commonJS({
...
var require_source_map_generator = /* @__PURE__ */ __commonJS({
...
function getWalkersFromStructure(name$49, nodeType) {
    ...
    for(const key in structure$49){
        ...
        if (!Array.isArray(fieldTypes)) fieldTypes = [
            fieldTypes
        ];
    ...
    function walk$2(node$1) {
        ...
        switch(node$1.type){
            ...
            case "Comma":
                break;
            default:
                throw new Error("Unknown type: " + node$1.type);
        }
                ...
                for(let i = 0; !valid && i < fields[key].length; i++){
                    ...
                    switch(fieldType){
                        ...
                        case null:
                            ...
                            break;
                        default:
                            if (typeof fieldType === "string") valid = node[key] && node[key].type === fieldType;
...
function processStructure(name$49, nodeType) {
    ...
    for(const key in structure$49){
        ...
        docs[key] = genTypesList(fields[key] = Array.isArray(structure$49[key]) ? structure$49[key].slice() : [
            structure$49[key]
        ], name$49 + "." + key);
    }
    return {
...
function dumpMapSyntax(map, compact, syntaxAsAst) {
    const result = {};
    for(const name$49 in map)if (map[name$49].syntax) result[name$49] = syntaxAsAst ? map[name$49].syntax : generate$50(map[name$49].syntax, {
        compact
    });
    return result;
}
function dumpAtruleMapSyntax(map, compact, syntaxAsAst) {
    ...
    for (const [name$49, atrule] of Object.entries(map))result[name$49] = {
        prelude: atrule.prelude && (syntaxAsAst ? atrule.prelude.syntax : generate$50(atrule.prelude.syntax, {
            compact
        })),
...
var Lexer = class {
    ...
    createDescriptor(syntax, type, name$49, parent = null) {
        ...
        if (typeof syntax === "function") descriptor.match = buildMatchGraph(syntax, ref);
            ...
            if (typeof syntax === "string") Object.defineProperty(descriptor, "syntax", {
                get () {
                    Object.defineProperty(descriptor, "syntax", {
                        value: parse$50(syntax)
                    });
    ...
    validate() {
        ...
        const brokenTypesArray = [
            ...brokenTypes.keys()
        ].filter((name$49)=>brokenTypes.get(name$49));
        const brokenPropertiesArray = [
            ...brokenProperties.keys()
        ].filter((name$49)=>brokenProperties.get(name$49));
...
function preprocessPatchAtrulesDescritors(declarations) {
    const result = {};
    for (const [key, value] of Object.entries(declarations || {}))result[key] = typeof value === "string" ? {
        syntax: value
    } : value;
    return result;
}
...
function parse$5(isStyleBlock) {
    ...
    scan: while(!this.eof)switch(this.tokenType){
        ...
        case AtKeyword:
            ...
            break;
        default:
            if (isStyleBlock && this.isDelim(AMPERSAND$4)) children.push(consumeRule.call(this));
...
function parse$14() {
    ...
    scan: while(!this.eof)switch(this.tokenType){
        ...
        case AtKeyword:
            ...
            break;
        default:
            if (this.isDelim(AMPERSAND$2)) children.push(this.parseWithFallback(this.Rule, consumeRaw$2));
...
function readTerm() {
    ...
    switch(this.tokenType){
        case Number$1:
            if (this.isDelim(SOLIDUS$3, this.lookupOffsetNonSC(1))) return this.Ratio();
...
function defaultRecognizer(context) {
    switch(this.tokenType){
        ...
        case Url:
            return this.Url();
        case Ident:
            if (this.cmpChar(this.tokenStart, U) && this.cmpChar(this.tokenStart + 1, PLUSSIGN$1)) return this.UnicodeRange();
...
function resolveAllCssVariables(node) {
                        ...
                        walk(node$2, {
                            ...
                            enter (funcNode) {
                                if (funcNode.name === "var") {
                                    ...
                                    if (fallback?.includes("var(")) parseVariableUsesFrom(parse(fallback, {
                                        context: "value"
                                    }));
                                }
                            }
    ...
    for (const use of variableUses){
        ...
        if (!hasReplaced && use.fallback) use.declaration.value = parse(generate(use.declaration.value).replaceAll(use.raw, use.fallback), {
            context: "value"
        });
    }
}
...
/** Convert oklab to RGB */ function oklchToRgb(oklch) {
...
function separteShorthandDeclaration(shorthandToReplace, [start, end]) {
    ...
    const values = shorthandToReplace.value.type === "Value" ? shorthandToReplace.value.children.toArray().filter((child)=>child.type === "Dimension" || child.type === "Number" || child.type === "Percentage") : [
...
*/ function sanitizeDeclarations(nodeContainingDeclarations) {
    walk(nodeContainingDeclarations, {
        ...
        enter (declaration, item, list) {
            if (declaration.value.type === "Raw") declaration.value = parse(declaration.value.value, {
                context: "value"
            });
            if (/border-radius\s*:\s*calc\s*\(\s*infinity\s*\*\s*1px\s*\)/i.test(generate(declaration))) declaration.value = parse("9999px", {
                context: "value"
            });
            walk(declaration, {
                visit: "Function",
                enter (func, funcParentListItem) {
                    ...
                    if (func.name === "oklch") {
                        ...
                        if (l === void 0 || c === void 0 || h === void 0) throw new Error("Could not determine the parameters of an oklch() function.", {
                            cause: declaration
                        });
                    ...
                    if (func.name === "rgb") {
                        ...
                        if (r === void 0 || g === void 0 || b === void 0) throw new Error("Could not determine the parameters of an rgb() function.", {
                            cause: declaration
                        });
...
function useSuspensedPromise(promiseFn, key) {
    ...
    const state = {
        promise: promiseFn().then((result)=>state.result = result).catch((error)=>state.error = error)
    };
...
const componentsToTreatAsElements = [
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$body$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Body"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$button$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Button"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$code$2d$block$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["CodeBlock"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$code$2d$inline$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["CodeInline"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$container$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Container"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$heading$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Heading"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$hr$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Hr"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$img$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Img"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$link$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Link"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$preview$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Preview"],
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$email$2f$text$2f$dist$2f$index$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__["Text"]
];
...
*/ function mapReactTree(value, process) {
    const mapped = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["default"].Children.map(value, (node)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["default"].isValidElement(node)) {
            const newProps = {
                ...node.props
            };
            if (node.props.children && !isComponent(node)) newProps.children = mapReactTree(node.props.children, process);
            const processed = process(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["default"].cloneElement(node, newProps, newProps.children));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["default"].isValidElement(processed) && isComponent(processed)) return mapReactTree((typeof processed.type === "object" ? processed.type.render : processed.type)(processed.props), process);
            return processed;
        }
        return process(node);
    });
...
function cloneElementWithInlinedStyles(element, inlinableRules, nonInlinableRules, customProperties) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["default"].cloneElement(element, newProps, newProps.children);
}
//#endregion
...
@config;
`;
    const compiler = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwindcss$2f$dist$2f$chunk$2d$MEY3PWYT$2e$mjs__$5b$instrumentation$5d$__$28$ecmascript$29$__$3c$export__d__as__compile$3e$__["compile"])(baseCss, {
...
function Tailwind({ children, config }) {
    ...
    let mappedChildren = mapReactTree(children, (node)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["isValidElement"](node)) {
    ...
    mappedChildren = mapReactTree(mappedChildren, (node)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["isValidElement"](node)) {
            ...
            if (elementWithInlinedStyles.type === "head") {
                ...
                const styleElement = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$runtime$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["jsx"])("style", {
                    children: generate(nonInlineStyles)
                });
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["cloneElement"](elementWithInlinedStyles, elementWithInlinedStyles.props, styleElement, elementWithInlinedStyles.props.children);
            }
...
//# sourceMappingURL=node_modules_%40react-email_tailwind_dist_index_mjs_8532ef28._.js.map