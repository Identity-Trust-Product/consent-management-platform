...
"[project]/.next-internal/server/app/cms/principal/dprm/[access_token]/notifications/page/actions.js { ACTIONS_MODULE0 => \"[project]/actions/dprm.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/actions/fiduciary-config.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/cms/principal/dprm/[access_token]/notifications/page/actions.js { ACTIONS_MODULE0 => \"[project]/actions/dprm.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/actions/fiduciary-config.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const NotificationsClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call NotificationsClient() from the server but NotificationsClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx <module evaluation>", "NotificationsClient");
}),
"[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const NotificationsClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call NotificationsClient() from the server but NotificationsClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx", "NotificationsClient");
}),
"[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cms$2f$principal$2f$dprm$2f5b$access_token$5d2f$notifications$2f$notifications$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cms$2f$principal$2f$dprm$2f5b$access_token$5d2f$notifications$2f$notifications$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cms$2f$principal$2f$dprm$2f5b$access_token$5d2f$notifications$2f$notifications$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/app/cms/principal/dprm/[access_token]/notifications/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-jsx-dev-runtime.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cms$2f$principal$2f$dprm$2f5b$access_token$5d2f$notifications$2f$notifications$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-rsc] (ecmascript)");
...
async function getNotificationsData(dpId) {
    // Get count of unread notifications
    const unreadCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].notification.count({
        where: {
    ...
    const expiryNotifications = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].notification.findMany({
        where: {
            dataPrincipalId: dpId,
            type: "expiry"
        },
    ...
    const allNotificationConsentIds = Array.from(new Set(expiryNotifications.map((n)=>getMetaObject(n.metadata).consentPublicId).filter((x)=>typeof x === "string")));
    // Query accepted consents only
    const acceptedConsents = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].consent.findMany({
        where: {
            publicId: {
                in: allNotificationConsentIds
            },
            status: "accepted"
        },
        select: {
    ...
    expiryNotifications.filter((n)=>!n.seen).forEach((notification)=>{
        const meta = getMetaObject(notification.metadata);
        const consentPublicId = meta.consentPublicId;
    ...
    const latestExpiryNotification = expiryNotifications.find((n)=>{
        ...
        return !n.seen && meta.consentPublicId && acceptedConsentIds.has(meta.consentPublicId);
    });
    // Get update notifications count (using the diff!)
    const consentsWithDiffs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$consent$2d$version$2d$diff$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getConsentsWithVersionDiffs"])(dpId.toString());
    const updateConsentCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$consent$2d$update$2d$transform$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUpdateNotificationCount"])(consentsWithDiffs);
    const totalUpdatesAvailable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$consent$2d$update$2d$transform$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTotalUpdateCount"])(consentsWithDiffs);
    // Get grievance notifications
    const grievanceNotifications = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].notification.findMany({
        where: {
            dataPrincipalId: dpId,
    ...
    let latestGrievanceTimestamp = null;
    ...
    return {
        ...
        latestExpiryTimestamp: latestExpiryNotification?.id ? new Date().toISOString() : null,
        expiryNotifications: expiryNotifications.filter((n)=>{
            const meta = getMetaObject(n.metadata);
            return meta.consentPublicId && acceptedConsentIds.has(meta.consentPublicId);
        }).map((n)=>({
                id: n.id,
                seen: n.seen,
                metadata: getMetaObject(n.metadata)
            })),
        updateConsentCount,
...
async function NotificationsPage({ sessionContext, searchParams }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cms$2f$principal$2f$dprm$2f5b$access_token$5d2f$notifications$2f$notifications$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NotificationsClient"], {
        notificationsData: notificationsData
    }, void 0, false, {
        fileName: "[project]/app/cms/principal/dprm/[access_token]/notifications/page.tsx",
        lineNumber: 221,
        columnNumber: 10
    }, this);
}
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hoc$2f$with$2d$dprm$2d$session$2d$handler$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["withDprmSessionHandler"])(NotificationsPage);
const dynamic = "force-dynamic";
}),
"[project]/app/cms/principal/dprm/[access_token]/notifications/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/app/cms/principal/dprm/[access_token]/notifications/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87931ee2._.js.map