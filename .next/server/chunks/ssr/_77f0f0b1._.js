...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/jose/dist/webapi/jwt/verify.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/crypto [external] (crypto, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canonicalize$2f$lib$2f$canonicalize$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/canonicalize/lib/canonicalize.js [app-ssr] (ecmascript)");
;
;
;
;
...
async function generateAccessToken(attrs, expiresAt) {
    ...
    const jwt = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignJWT"](attrs).setProtectedHeader({
        alg: "HS256"
...
async function verifyAccessToken(token) {
    const secret = new TextEncoder().encode(process.env.NEXTAUTH_SECRET || "your-secret-key");
    try {
        const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jwtVerify"])(token, secret);
        return payload;
    } catch (error) {
...
function generateHash(data) {
    ...
    const encoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$canonicalize$2f$lib$2f$canonicalize$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(data);
    if (!encoded) return "";
...
"[project]/lib/constants/ui.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/utils/notice-translations.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAvailableNoticeLanguages(businessProcess) {
    const languages = [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$languages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_LANGUAGE"]
    ];
    if (businessProcess.supportedLanguages && Array.isArray(businessProcess.supportedLanguages)) {
        ...
        const additionalLanguages = businessProcess.supportedLanguages.filter((lang)=>lang !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$languages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_LANGUAGE"]);
        languages.push(...additionalLanguages);
    }
    return languages;
}
}),
"[project]/lib/utils/speech-readout-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function prepareNoticeReadoutContent(notice, translate, currentLanguage, options = {}) {
    const sections = [];
 ...
 */ function buildProcessingPurposeSection(pp, currentLanguage, translate) {
    const translatedPP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notice$2d$translations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBaseEntityTranslation"])(pp.translations, currentLanguage, {
        name: pp.name,
    ...
    if (pp.userAttributes && pp.userAttributes.length > 0) {
        const attributes = pp.userAttributes.map((attr)=>{
            const translatedUA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notice$2d$translations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserAttributeTranslation"])(attr.translations, currentLanguage, attr.name);
            return translatedUA;
        }).join(', ');
...
"[project]/actions/data:66f0dc [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/cms/principal/notice/[notice_id]/_components/already-submitted-page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$66f0dc__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:66f0dc [app-ssr] (ecmascript) <text/javascript>");
...
;
;
function AlreadySubmittedPage({ noticeId, dataPrincipalId, submittedAt, onClose, accessToken, forMinor = false, metadata = [] }) {
    ...
    const handleManageConsents = async ()=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$66f0dc__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateDprmLinkForNotice"])({
                dataPrincipalId,
                forMinor,
                metadata
            });
            if (result.success && result.url) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(result.error || "Failed to generate DPRM link");
            }
        } catch (error) {
            console.error("Error generating DPRM link:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to generate DPRM link");
        }
    };
    const handleViewReceipt = ()=>{
        if (!accessToken) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Access token not available");
            return;
        }
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    submittedAt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/app/cms/principal/notice/[notice_id]/_components/success-page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Unauthorized copying, modification, distribution, or commercial use
 * is strictly prohibited without prior written permission from IDfy.
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$icons$2f$notice$2d$icons$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/icons/notice-icons.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$66f0dc__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:66f0dc [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sonner/dist/index.mjs [app-ssr] (ecmascript)");
...
;
;
function SuccessPage({ title, description, dataPrincipalId, noticePublicId, accessToken, forMinor = false, metadata = [], lang = "en" }) {
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$consent$2d$receipt$2d$translations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getReceiptTranslation"])(lang);
    const displayTitle = title || t.successTitle;
    const displayDescription = description || t.successDesc;
    const handleManageConsents = async ()=>{
        if (!dataPrincipalId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("User ID not available");
            return;
        }
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$66f0dc__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateDprmLinkForNotice"])({
    ...
    const handleViewReceipt = ()=>{
        if (!noticePublicId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Notice ID not available");
            return;
        }
        if (!accessToken) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Access token not available");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$icons$2f$notice$2d$icons$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GrantNoticeIcon"], {}, void 0, false, {
...
"[project]/contexts/high-contrast-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const HighContrastContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])({
...
function HighContrastProvider({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(HighContrastContext.Provider, {
        value: {
            isHighContrast,
            setIsHighContrast
        },
...
function useHighContrast() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(HighContrastContext);
...
"[project]/contexts/notice-language-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const NoticeLanguageContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function NoticeLanguageProvider({ children, availableLanguages, defaultLanguage = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$languages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_LANGUAGE"] }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(NoticeLanguageContext.Provider, {
        value: {
            currentLanguage,
            availableLanguages,
            setLanguage
...
function useNoticeLanguage() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(NoticeLanguageContext);
    if (!context) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$ui$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/constants/ui.ts [app-ssr] (ecmascript)");
;
;
function useIsMobile() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        const mql = window.matchMedia(`(max-width: ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$ui$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOBILE_BREAKPOINT"] - 1}px)`);
        const onChange = ()=>{
            setIsMobile(window.innerWidth < __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$ui$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOBILE_BREAKPOINT"]);
        };
...
"[project]/hooks/use-notice-translation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function loadTranslations(languageCode, namespace) {
    ...
    try {
        ...
        try {
            ...
            })(`@/translations/${languageCode}/${namespace}.json`);
        } catch (e) {
            if (namespace !== "common") {
                ...
                })(`@/translations/${languageCode}/common.json`);
            } else {
                throw e;
            }
        }
...
function useNoticeTranslation(namespace = "common") {
    ...
    const translations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
"[project]/hooks/use-notice-consent.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useNoticeConsent(notice) {
    ...
    const [consentSelections, setConsentSelections] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        const initial = {};
        consentPurposes.forEach((cp)=>{
            ...
            const hasMandatoryProcessingPurposes = cp.processingPurposes.some((pp)=>pp.mandatory);
            initial[cp.id] = {
    ...
    const overallSelectionState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const getConsentPurposeSelectionState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((consentPurposeId)=>{
    ...
    const getProcessingPurposeSelectionState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((processingPurposeId)=>{
    ...
    const handleSelectAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        setConsentSelections((prev)=>{
            ...
            Object.keys(updated).forEach((cpId)=>{
                ...
                const consentPurpose = consentPurposes.find((cp)=>cp.id === consentPurposeId);
                const processingPurposes = Object.keys(updated[consentPurposeId].processingPurposes).reduce((acc, ppId)=>{
                    const processingPurposeId = parseInt(ppId);
                    const processingPurpose = consentPurpose?.processingPurposes.find((pp)=>pp.id === processingPurposeId);
                    // Keep mandatory processing purposes selected, toggle others
                    acc[processingPurposeId] = processingPurpose?.mandatory || shouldSelectAll;
                    return acc;
                }, {});
    ...
    const handleConsentPurposeChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((consentPurposeId, selected)=>{
        // Find the consent purpose data to check for mandatory processing purposes
        const consentPurpose = consentPurposes.find((cp)=>cp.id === consentPurposeId);
        setConsentSelections((prev)=>{
            const processingPurposes = Object.keys(prev[consentPurposeId].processingPurposes).reduce((acc, ppId)=>{
                const processingPurposeId = parseInt(ppId);
                const processingPurpose = consentPurpose?.processingPurposes.find((pp)=>pp.id === processingPurposeId);
    ...
    const handleProcessingPurposeChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((consentPurposeId, processingPurposeId, selected)=>{
    ...
    const getSelectedConsents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        return Object.values(consentSelections).filter((s)=>s.selected);
    }, [
        consentSelections
    ]);
    // Get selected business process rules (new format)
    const getSelectedRules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        const selectedRules = [];
        // Convert consent-based selections to rule-based selections
        Object.values(consentSelections).forEach((consentSelection)=>{
            Object.entries(consentSelection.processingPurposes).forEach(([processingPurposeId, selected])=>{
                // Find the corresponding rule
                const rule = notice.businessProcess.businessProcessRules.find((r)=>r.consentPurposeId === consentSelection.consentPurposeId && r.processingPurposeId === parseInt(processingPurposeId));
                if (rule) {
                    selectedRules.push({
                        ruleId: rule.id,
                        selected: selected
    ...
    const hasSelections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>Object.values(consentSelections).some((s)=>s.selected), [
        consentSelections
    ]);
    // Check if a consent purpose should be disabled (all processing purposes are mandatory)
    const isConsentPurposeDisabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((consentPurposeId)=>{
        const consentPurpose = consentPurposes.find((cp)=>cp.id === consentPurposeId);
    ...
    const isOverallSelectDisabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const allProcessingPurposes = consentPurposes.flatMap((cp)=>cp.processingPurposes);
        return allProcessingPurposes.length > 0 && allProcessingPurposes.every((pp)=>pp.mandatory);
    }, [
        consentPurposes
    ]);
    return {
...
//# sourceMappingURL=_77f0f0b1._.js.map