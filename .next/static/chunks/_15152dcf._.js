...
"[project]/actions/data:dcb027 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/actions/data:08a11b [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$dcb027__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:dcb027 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$08a11b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:08a11b [app-client] (ecmascript) <text/javascript>");
...
function BusinessUnitForm(param) {
    ...
    const onSubmit = async (formData)=>{
        ...
        try {
            let result;
            if (mode === "new") {
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$dcb027__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createBusinessUnit"])({
                    name: formData.name,
                    code: formData.code
                });
            } else {
                const id = parseInt(businessUnitId);
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$08a11b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateBusinessUnit"])({
                    id,
                    data: {
                        name: formData.name
                    }
...
//# sourceMappingURL=_15152dcf._.js.map