...
"[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function NotificationsClient(param) {
    let { notificationsData } = param;
    _s();
    ...
    const { currentLanguage: language } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$notice$2d$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNoticeLanguage"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    const baseUrl = pathname.split("/").slice(0, 5).join("/");
    const homeUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dprm$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDprmLink"])(baseUrl, searchParams);
    const consentActionCenterPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dprm$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDprmLink"])("".concat(baseUrl, "/consent-action-center"), searchParams);
    const renewConsentPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dprm$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDprmLink"])("".concat(baseUrl, "/consent-action-center?type=update"), searchParams);
    // Format timestamp
    ...
    if (notificationsData.updateConsentCount > 0) {
        notificationCards.push({
            ...
            content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: t("consents_require_update", {
                    count: notificationsData.updateConsentCount
                })
            }, void 0, false, {
                fileName: "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx",
                lineNumber: 101,
                columnNumber: 9
            }, this),
            timestamp: formatTimestamp(new Date().toISOString()),
            buttonText: t("Review and Update Consent"),
            buttonLink: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dprm$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDprmLink"])("".concat(baseUrl, "/consent-action-center?type=update"), searchParams)
        });
    }
    ...
    if (notificationsData.consentsExpiringCount > 0) {
        notificationCards.push({
            ...
            content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: t(notificationsData.consentsExpiringCount === 1 ? "consents_about_to_expire_one" : "consents_about_to_expire_other", {
    ...
    if (notificationsData.grievanceUpdatesCount > 0) {
        const grievancesPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dprm$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDprmLink"])("".concat(baseUrl, "/grievances"), searchParams);
        // Build content based on what types of updates exist
        const contentParts = [];
        if (notificationsData.withdrawalRejectedCount > 0) {
            contentParts.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "mb-1",
                children: t(notificationsData.withdrawalRejectedCount === 1 ? "withdrawal_rejected_one" : "withdrawal_rejected_other", {
        ...
        if (notificationsData.withdrawalAcceptedCount > 0) {
            contentParts.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: contentParts.length > 0 ? "" : "mb-1",
                children: t(notificationsData.withdrawalAcceptedCount === 1 ? "withdrawal_accepted_one" : "withdrawal_accepted_other", {
        ...
        if (contentParts.length === 0) {
            contentParts.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: t(notificationsData.grievanceUpdatesCount === 1 ? "grievance_update_one" : "grievance_update_other", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dprm$2f$dprm$2d$page$2d$header$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DprmPageHeader"], {
                ...
                backHref: homeUrl,
                action: notificationsData.unreadCount > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                    className: "bg-blue-600 text-white hover:bg-blue-700",
                    children: t("{{count}} New", {
                        count: notificationsData.unreadCount
                    })
                }, void 0, false, {
                    fileName: "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx",
                    lineNumber: 208,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: notificationCards.length > 0 ? notificationCards.map((card)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NotificationCard, {
                    ...
                    children: t("No notifications at this time")
                }, void 0, false, {
                    fileName: "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx",
                    lineNumber: 266,
                    columnNumber: 11
...
_s(NotificationsClient, "DQu4XzFUzOkkwFU7gCrcqAiA3DM=", false, function() {
    return [
...
function NotificationCard(param) {
    let { dotColor, title, content, timestamp, buttonText, buttonLink } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full bg-white rounded-lg border border-[#E7E8E9] p-4",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "h-2.5 w-2.5 rounded-full ".concat(dotColor),
                            "aria-hidden": "true"
                        }, void 0, false, {
                            fileName: "[project]/app/cms/principal/dprm/[access_token]/notifications/notifications-client.tsx",
                            lineNumber: 298,
...
_c1 = NotificationCard;
var _c, _c1;
__turbopack_context__.k.register(_c, "NotificationsClient");
__turbopack_context__.k.register(_c1, "NotificationCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1a9060e8._.js.map