...
import { FiduciaryLogoMobile } from "@/components/fiduciary-logo";
...
import { Bell, ChevronDown, Languages, User, Baby } from "lucide-react";
...
export function MobileNavbar() {
  ...
  return (
    <div>
      {/* Top Utility Bar */}
      <div className="flex justify-end items-center gap-2 px-3 py-1.5 bg-neutral-300 h-9">
        {/* Font size toggles */}
      ...
      {/* Main Mobile Navbar */}
      <div className="bg-white border-b border-neutral-50 px-3 py-3 w-full">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            {/* Notifications Bell */}
            <Button variant="ghost" className="relative p-1.5 h-8 w-8" asChild>
              <Link
                href={createDprmLink(`${homeUrl}/notifications`, searchParams)}
              >
                <AnimatedBellIcon />
                <span className="absolute bottom-5 left-4.5 h-1.5 w-1.5 bg-red-500 rounded-full"></span>
              </Link>
            </Button>
            ...
            <DropdownMenu onOpenChange={handleDropdownOpen}>
              <DropdownMenuTrigger asChild>
                ...
                >
                  <span className="text-primary-500 px-2 flex items-center font-medium border border-neutral-50 rounded-l-lg text-sm whitespace-nowrap max-w-[100px] truncate">
                    {currentMinorId
                  ...
                  <div className="flex items-center gap-0.5 bg-primary-500 px-2 flex-1">
